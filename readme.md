...
SmartChef — это web-приложение, которое подбирает персонализированные рецепты и меню на день с учётом калорийности, предпочтений и времени, которое пользователь готов потратить на готовку.
